...
int main()
{
	...
	*/
	...
	glm::mat4 base(1.0);
	glm::mat4 llanta1(1.0);
	glm::mat4 llanta2(1.0);
	glm::mat4 llanta3(1.0);
	glm::mat4 llanta4(1.0);
	glm::mat4 base1(1.0);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		base = modelaux = model; // Se guarda la posición de la cabina para generar la base
		...
		// Cuerpo de las llantas
		base = glm::translate(base, glm::vec3(0.0f, -3.0f, 0.0f));
		llanta1 = llanta2 = llanta3 = llanta4 = base;
		base = glm::scale(base, glm::vec3(6.0f, 1.5f, 3.0f));
		...
		base1 = glm::scale(base, glm::vec3(1.0f, 1.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(base1));
		...
		// Llanta 1
		llanta1 = glm::scale(llanta1, glm::vec3(2.5f, 2.5f, 2.5f));
		llanta1 = glm::rotate(llanta1, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		// Llanta 2
		llanta2 = glm::scale(llanta2, glm::vec3(2.5f, 2.5f, 2.5f));
		llanta2 = glm::rotate(llanta2, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		// Llanta 3
		llanta3 = glm::scale(llanta3, glm::vec3(2.5f, 2.5f, 2.5f));
		llanta3 = glm::rotate(llanta3, glm::radians(270.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		// Llanta 4
		llanta4 = glm::scale(llanta4, glm::vec3(2.5f, 2.5f, 2.5f));
		llanta4 = glm::rotate(llanta4, glm::radians(270.0f), glm::vec3(1.0f, 0.0f, 0.0f));
